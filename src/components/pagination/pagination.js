...
var TcPagination = /** @class */ (function (_super) {
            ...
            var _loop_1 = function (i) {
                pages.push({
                    ...
                    click: function (event) {
                        ...
                        _this.$nextTick(function () { return event.target.focus(); });
                    }
                });
            };
            var this_1 = this;
    ...
    tslib_1.__decorate([
        Prop({ default: 1 })
    ], TcPagination.prototype, "total", void 0);
    tslib_1.__decorate([
        Prop({ default: 10 })
    ], TcPagination.prototype, "perPage", void 0);
    tslib_1.__decorate([
        Prop({ default: 1 })
    ], TcPagination.prototype, "current", void 0);
    tslib_1.__decorate([
        Watch("pageCount")
    ], TcPagination.prototype, "pageCountChanged", null);
    TcPagination = tslib_1.__decorate([
        Component({})
    ], TcPagination);
    return TcPagination;
}(Vue));
