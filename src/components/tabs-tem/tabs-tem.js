...
var TimeIcon = function () { return import('./icons/time.vue'); };
var ExpenseIcon = function () { return import('./icons/expense.vue'); };
var MileageIcon = function () { return import('./icons/mileage.vue'); };
var TcTabsTem = /** @class */ (function (_super) {
    ...
    tslib_1.__decorate([
        Prop({ default: 'time' })
    ], TcTabsTem.prototype, "value", void 0);
