...
import { formatTime, TcDate, cloneObject } from "@timechimp-bv/helper-functions";
var TcTimer = /** @class */ (function (_super) {
    ...
    tslib_1.__decorate([
        Prop()
    ], TcTimer.prototype, "timerStart", void 0);
    tslib_1.__decorate([
        Prop({ default: 0 })
    ], TcTimer.prototype, "duration", void 0);
    TcTimer = tslib_1.__decorate([
        Component({})
    ], TcTimer);
    return TcTimer;
}(Vue));
